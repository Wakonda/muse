...
var itemStatusElem=document.getElementById('tacCurrentStatus'+key);if(status==!0){itemStatusElem.innerHTML=tarteaucitron.lang.allowed;tarteaucitron.sendEvent(key+'_allowed')}else{itemStatusElem.innerHTML=tarteaucitron.lang.disallowed;tarteaucitron.sendEvent(key+'_disallowed')}
