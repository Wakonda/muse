...
class Instagram {
	...
	public function setLanguage($language)
	{
		...
		{
			case "fr":
				$this->FACEBOOK_PAGE_ID = $_ENV["FACEBOOK_PAGE_ID_FR"];
				$this->FACEBOOK_APP_ID = $_ENV["FACEBOOK_APP_ID_FR"];
				$this->FACEBOOK_SECRET_KEY = $_ENV["FACEBOOK_SECRET_KEY_FR"];
				$this->FACEBOOK_GRAPH_VERSION = $_ENV["FACEBOOK_GRAPH_VERSION_FR"];
				$this->FACEBOOK_USER_ID = $_ENV["FACEBOOK_USER_ID_FR"];
				$this->FACEBOOK_ACCESS_TOKEN = $_ENV["FACEBOOK_ACCESS_TOKEN_FR"];
				$this->FACEBOOK_USER_INSTAGRAM_ID = $_ENV["FACEBOOK_USER_INSTAGRAM_ID_FR"];
				break;
		}
	}
